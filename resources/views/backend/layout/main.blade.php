...
<html lang="en">
    ...
    <head>
        ...
        <title>TANDIKEK | Dashboard</title>
        <!--begin::Primary Meta Tags-->
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="title" content="TANDIKEK | Dashboard" />
                        ...
                        <li class="nav-item dropdown user-menu">
                            ...
                            >
                                <img
                                    src="{{
                                        asset(
                                            'assets/gambar/img/user2-160x160.jpg'
                                        )
                                    }}"
                ...
                <!--begin::Sidebar Brand-->
                  <div class="sidebar-brand">
                    ...
                    <a href="./index.html" class="brand-link">
                        ...
                        <img
                            src="{{
                                asset('assets/gambar/img/Pasaman_Barat.png')
                            }}"
                            alt="AdminLTE Logo"
                        ...
                        <!--end::Brand Image-->
                        <!--begin::Brand Text-->
                        <span class="brand-text fw-light">TANDIKEK</span>
                        <!--end::Brand Text-->
                    </a>
                    <!--end::Brand Link-->
                </div>
